...
void CtutorialBackground::Init() {
	...
	D3DX11CreateShaderResourceViewFromFile(
		CRenderer::GetDevice(),
		"asset/texture/spaceTutorial.jpg",
		NULL,
		NULL,
		&m_Texture,
		NULL
...
void CtutorialBackground::Uninit() {
...
void CtutorialBackground::Update() {
...
void CtutorialBackground::Draw() {
	...
	//プリミティブトポロジ設定
	CRenderer::GetDeviceContext()->IASetPrimitiveTopology(D3D10_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP);
